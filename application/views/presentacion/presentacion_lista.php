...
<div class="x_title">
	<h2>Presentaciones de producto registradas</h2>
	<ul class="nav navbar-right panel_toolbox">
		<li><button type="button" class="btn btn-success" style="color:#fff" onclick="location.href='<?=base_url().'registrar_presentacion'?>'"><i class="fa fa-plus"></i> Registrar</button></li>
	</ul>
</div>
...
<div class="x_content">
	<table id="datatable" class="table table-striped table-bordered">
	  ...
	  <tbody>
	  		<?php foreach($presentaciones->result() as $info): ?>
