      ...
      <div class="main_container">
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a class="site_title"><span>Son de Miel</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?=base_url().'home'?>"><i class="fa fa-home"></i> Empresa</a></li>
                  <li><a href="<?=base_url().'home'?>"><i class="fa fa-home"></i> Almacen</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="<?=base_url().'logout'?>"><i class="fa fa-sign-out pull-right"></i> Salir</a></li>
                  </ul>
                </li>
              </ul>
            </nav>
        ...
        <footer>
          <div class="pull-right">
            Powered by <a href="http://www.dabiaani.com">Dabiaani Software House</a>
          </div>
          <div class="clearfix"></div>
        </footer>
      </div>
